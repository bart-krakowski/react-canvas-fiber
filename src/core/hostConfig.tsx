...
import { ChildSet, Container, HostContext, HydratableInstance, Instance, InstanceAttributes, NoTimeout, Props, PublicInstance, SuspenseInstance, TextInstance, TimeoutHandle, Type, UpdatePayload } from './types';
    ...
    for (const key in newProps) {
      if (Object.prototype.hasOwnProperty.call(newProps, key)) {
        ...
        if (oldProps[typedKey] !== newProps[typedKey]) {
          (updatePayload as Record<keyof Props, unknown>)[typedKey] =
            newProps[typedKey];
        }
      }
    }
